...
namespace TeacherControl2016.ReporteForm
{
    public partial class CursosReportes : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'teacherControlDbDataSetNew.Curso' table. You can move, or remove it, as needed.
            this.cursoTableAdapter.Fill(this.teacherControlDbDataSetNew.Curso);
