...
namespace TeacherControl2016.ReporteForm
{
    public partial class ReporteUsuarios : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'teacherControlDbDataSetNew.Usuario' table. You can move, or remove it, as needed.
            this.usuarioTableAdapter.Fill(this.teacherControlDbDataSetNew.Usuario);
