...
SELECT usuarioId, nombre, apellido, email, direccion FROM Usuario WHERE (usuarioId = @usuarioId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT usuarioId, nombre, apellido, email, direccion FROM dbo.Usuario";
        ...
        public virtual int FillByUsuarios(TeacherControlDbDataSet.UsuarioDataTable dataTable) {
        ...
        public virtual TeacherControlDbDataSet.UsuarioDataTable GetDataByUsuarios() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            TeacherControlDbDataSet.UsuarioDataTable dataTable = new TeacherControlDbDataSet.UsuarioDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
